...
class MicGpsActivity : AppCompatActivity(), LocationListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_CODE_MIC) {
            ...
            if (data != null) {
                //Use the getStringArrayListExtra() method
                // to extract data from the array list containing the speech recognition results
                ...
                uploadMicButton.setOnClickListener {
                    ...
                    database.child("user").child(uid).child(key.toString())
